...
class Aboutbraca extends CI_Controller {
	public function index(){
		$query = $this->model_utama->view_where('mod_alamat',array('id_alamat' => 1));
		$data['iden'] = $this->model_utama->view_where('halamanstatis',array('id_halaman' => 1))->row_array();
		$row = $query->row_array();
		...
		$this->template->load(template().'/template',template().'/aboutbraca',$data);
	}
