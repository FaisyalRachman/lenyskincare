...
class Whybraca extends CI_Controller {
	public function index(){
			$jumlah= $this->model_utama->view('whybraca')->num_rows();
			$config['base_url'] = base_url().'whybraca/index/'.$this->uri->segment(3);
			...
			$this->template->load(template().'/template',template().'/whybraca',$data);
	}
