    ...
    echo "
              <div class='card card-info'>
                <div class='card-header with-border'>
                  <h3 class='card-title'>Edit Gallery Foto</h3>
                </div>
              <div class='card-body'>";
          ...
          echo "
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Ganti Foto</th>          <td><input type='file' class='form-control' name='d'>";
                                                                   if ($rows['gbr_gallery']!=''){ echo " Gambar Saat ini : <a target='_BLANK' href='".base_url()."asset/img_galeri/$rows[gbr_gallery]'>$rows[gbr_gallery]</a>"; } echo " : <small>Ukuran gambar * 600 x 400</small></td></tr>
                  </tbody>
                  </table>
                </div>
