    ...
    echo "
              <div class='card card-info'>
                <div class='card-header with-border'>
                  <h3 class='card-title'>Tambah Gallery Foto</h3>
                </div>
              <div class='card-body'>";
          ...
          echo "
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Gambar</th>                    <td><input type='file' class='form-control' name='d'> <small>Ukuran gambar * 600 x 400</small></td></tr>
                  </tbody>
                  </table>
