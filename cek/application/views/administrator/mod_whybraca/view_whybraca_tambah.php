    ...
    echo "
              <div class='card card-info'>
                <div class='card-header with-border'>
                  <h3 class='card-title'>Tambah Album Foto</h3>
                </div>
              <div class='card-body'>";
          ...
          echo "
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Cover</th>                    <td><input type='file' class='form-control' name='c'><small>Ukuran gambar * 740 x 414</small></td></tr>
                  </tbody>
                  </table>
