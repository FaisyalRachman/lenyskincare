<section style="margin-top:70px;border-bottom:none;background-image:url(<?php echo base_url('assets/img/lokasi_lenyskincare.png'); ?>);background-position: center;background-size: cover;">
  <div class="text-center title"><h2 class="project text-center" style="padding:0 !important;margin:0 !important;font-family:Century Gothic;font-weight:none !important;font-size:2.3em;color:#8B6FB9"><b>Kunjungi Klinik Kami</b></h2>
