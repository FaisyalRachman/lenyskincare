...
<div class="contentbg">
 		<div class="row">
 			<div class="col-xl-12 justify-content-center align-items-stretch">
 				...
 				<small style="padding:20px;"><span class="font-italic">By <b> <?php echo "$rows[nama_lengkap]"; ?> </b> </span>
			 ...
			 <div class="row">
			 <div class="col-xl-1 icon-boxes flex-column justify-content-center" style="padding:1px;">
</div>
 			<div class="col-xl-10 icon-boxes flex-column justify-content-center" style="padding:25px;">
 				<h3><?php echo $rows['judul']; ?></h3>
 				<p><?php echo $rows['isi_berita']; ?></p>

    <div class="social float-right"> <script language="javascript">
										document.write("<a href='http://www.facebook.com/share.php?u=" + document.URL + " ' target='_blank' class='custom-soc icon-text'><i class='ri-facebook-fill' style='font-size:20px'></i></a> <a href='http://twitter.com/home/?status=" + document.URL + "' target='_blank' class='custom-soc icon-text'><i class='ri-twitter-fill' style='font-size:20px'></i></a> <a href='mailto:info@integramitrasolusi.id' class='custom-soc icon-text'><i class='ri-mail-fill' style='font-size:20px'></i></a><a href='https://www.instagram.com/?url=" + document.URL + " ' target='_blank' class='custom-soc icon-text'><i class='ri-instagram-fill' style='font-size:20px'></i></a>");
										</script>
 		...
 		<div class="row">
 			...
 			<div class="col-xl-6 icon-boxes flex-column align-items-stretch justify-content-center" style="padding-left:50px;">
 				<?php
					...
					$content = "<h3>&nbsp;&nbsp;Berita Lainnya : </h3><ul>";
