...
class Profesionalteam extends CI_Controller {
	public function index(){
			$jumlah= $this->model_utama->view('album')->num_rows();
			$config['base_url'] = base_url().'profesionalteam/index/'.$this->uri->segment(3);
			...
			$this->template->load(template().'/template',template().'/profesionalteam',$data);
	}
