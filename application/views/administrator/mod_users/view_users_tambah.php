    ...
    echo "
          ...
          echo "
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Level</th>                   <td><input type='radio' name='g' value='member' checked> Member &nbsp; <input type='radio' name='g' value='staf'> Staf &nbsp; <input type='radio' name='g' value='supervisor'> Supervisor &nbsp; <input type='radio' name='g' value='admin'> Administrator
                  </tbody></table>
