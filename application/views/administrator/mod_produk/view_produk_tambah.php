<?php 
    echo "<div class='card'>
              ...
              echo form_open_multipart($this->uri->segment(1).'/tambah_listproduk',$attributes); 
          echo "<table class='table table-sm table-borderless'>
                  <tbody>
                    ...
                    <tr><th scope='row'>Produk Utama</th>           <td><input type='radio' name='g' value='Y'> Ya &nbsp; <input type='radio' name='g' value='N' checked> Tidak</td></tr>
                    <tr><th scope='row'>Isi Produk</th>             <td><textarea id='editor1' class='form-control' name='h' style='height:260px' required></textarea></td></tr>
                    <tr><th scope='row'>Gambar</th>                 <td><input type='file' class='form-control' name='userfile1'><small>Ukuran gambar * 1080 x 980</small></td></tr>
                    <tr><th scope='row'>Produksheet</th>                 <td><input type='file' class='form-control' name='userfile2'></td></tr>
