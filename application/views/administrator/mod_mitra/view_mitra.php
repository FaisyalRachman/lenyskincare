              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Cabang Leny Skin Care</h3>
                  <div class="card-tools">
      <a class='pull-right btn btn-primary btn-sm' href='<?php echo base_url() . $this->uri->segment(1); ?>/tambah_mitra'>Tambahkan Lokasi Cabang</a>
    </div>
                </div><!-- /.card-header -->
                <div class="card-body">
