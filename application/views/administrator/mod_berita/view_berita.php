      ...
      <?php 
        ...
        foreach ($record as $row){
          if ($this->session->level == 'admin') {
            $hps = base_url().$this->uri->segment(1)."/delete_listberita/$row[id_berita]";
          }
        ...
        echo "<tr><td><small>$no.</small></td>
                  <td><small><b>$row[judul]</b><br><i>Penulis : $row[nama_lengkap] - $tgl_posting</i><br>Meta Description : $row[meta_desc]</small></td>
