<section id="portfolio" class="portfolio" style="padding-top:120px;">
      ...
      <div class="text-center title">
          <h2 style="font-family:Century Gothic !important;font-size:2.3em;color:#8B6FB9;"><b>Rekomendasi Produk</b></h2>
      </div>
      <div class="row">
          <div class="col-lg-2">
          <label style="font-size:2em;">Kategori</label>
            <ul id="portfolio-flters">
               <?php 
            $gambar =  $this->model_utama->view('kategoriproduct');
          ...
          <div class="row">
            <?php 
            $gambar =  $this->model_utama->view_where_ordering_limit('subkategoriproduct',array('aktif' => 'Y','recomended' => 'Y'),'nama_subkategori','DESC','0','4');
            foreach ($gambar->result_array() as $gbr){
            ?>
          <div class="col-lg-3 col-md-6 portfolio-item <?php echo $gbr['id_kategori'];?>">
           <a href="<?php echo base_url('kategori/detailsubproduct/'.$gbr['id_subkategori'])?>"> <img src="asset/foto_produk/<?php echo $gbr['subgambar_utama'];?>" class="img-fluid" alt=""></a>
      ...
      <div class="text-center title">
        ...
        <div class="row">
          ...
          <div class="row portfolio-container">
            <?php 
            $gambar =  $this->model_utama->view('subkategoriproduct');
            foreach ($gambar->result_array() as $gbr){
            ?>
          <div class="col-lg-3 col-md-6 portfolio-item <?php echo $gbr['id_kategori'];?>">
           <a href="<?php echo base_url('kategori/detailsubproduct/'.$gbr['id_subkategori'])?>"> <img src="<?php echo base_url();?>asset/foto_produk/<?php echo $gbr['subgambar_utama'];?>" class="img-fluid" alt=""></a>
            <div class="portfolio-info">
              <h4><?php echo $gbr['nama_subkategori'];?></h4>
              <p><?php echo "Rp. " .number_format($gbr['subdeskripsi'],0,',','.');?></p>
              <a href="asset/foto_produk/<?php echo $gbr['subgambar_utama'];?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?php echo $gbr['nama_subkategori'];?>"><i class="bx bx-zoom-in"></i></a>
