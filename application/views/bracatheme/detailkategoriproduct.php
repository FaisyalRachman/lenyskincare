  ...
  <div class="row"><div class="col-lg-4"><img src="<?php echo base_url(); ?>assets/img/bgdetail/Klinik-Kecantikan-Tangerang-All-Product.jpg" alt="" class="img-responsive raunded mx-auto d-block" style="width:100%;padding:0px;"></div>
      <div class="col-lg-8"><p class="detailitem" style="margin-top:1px;"><h4 style="margin-left:16px;font-size:2.4em;font-family:verdana;color: #663390;">Produk Kategori <?php echo "$rows[nama_kategori]"; ?></h4></p>
...
<!-- AddToAny END --><button class="btn btn-primary btn-lg a2a_dd" style="color:#000;padding:1px 13px 1px 13px !important;font-family:verdana;border-radius:17px;background:none;border:#000 1px solid;font-size:1.2em;" onclick="location.href=https://www.addtoany.com/share">share <i class="fa fa-share-alt" style="font-size:1.0em"></i></button> <button class="btn btn-primary btn-lg" style="font-size:1.2em;padding:1px 13px 1px 13px !important;font-family:verdana;border-radius:17px;background:#25D366;border:none;" onclick="location.href='<?= base_url('hubungi') ?>'">booking</button>
</p></div>
<div class="col-lg-8"><div class="isiproduk"><?php echo "$rows[subdetail]"; ?></div> </div>
    ...
    <h4 style="font-size:2.0em;font-family:century gothic;color:#663390;font-weight:bold;">Rekomendasi produk serupa</h4>
          <div class="row portfolio" style="height:123px !important;">
            <?php 

            $gambar =  $this->model_utama->view_where_ordering_limit('subkategoriproduct',array('subkategoriproduct.id_kategori' => $rows['id_kategori'],'subkategoriproduct.id_subkategori !=' => $this->uri->segment('3')),'nama_subkategori','DESC','0','4');
